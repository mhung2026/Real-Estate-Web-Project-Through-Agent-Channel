...
export default function Agencydangtinpart2() {
  ...
  const sendImageUrlToAPI = (imageUrl) => {
    // Make a POST request to the API to send the image URL
    fetch("http://firstrealestate-001-site1.anytempurl.com/api/invester/getAllRealEstate", {
      method: "POST",
      headers: {
